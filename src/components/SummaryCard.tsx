...
const Chart: React.FC<{
  ...
  return (
    <div className="flex flex-col gap-5 rounded-2xl border border-gray-200/80 bg-white/70 p-5 text-sm shadow-sm transition-colors duration-300 ease-out dark:border-gray-700/60 dark:bg-gray-900/40">
